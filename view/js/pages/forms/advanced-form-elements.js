$(function () {
    ...
    //Mobile Phone Number
    $demoMaskedInput.find('.mobile-phone-number').inputmask('(999) 99999-99-99', { placeholder: '(___) _____-__-__' });
    //Phone Number
	...
	//rg
	$demoMaskedInput.find('.rg').inputmask('99.999.999-99', { placeholder: '__.___.___-__' });
