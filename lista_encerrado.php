...
<head>
    ...
    <script>
        ...
        $.post('lista_projeto_tabela.php?', function (tabela) {
    ...
    (function () {
        ...
        pesquisarFiltro = function () {
            ...
            programa = document.getElementById("fkPrograPesq").value;
                ...
                $.post('lista_projeto_tabela.php?filtro=ok', $form.serialize(), function (tabela) {
        ...
        excluir = function (idProjeto) {
            ...
            $.post('lista_projeto_tabela.php?excluir=ok&idProjeto=' + idProjeto + '', function (tabela) {
                $("#tdProjetos").html(tabela);
            });
