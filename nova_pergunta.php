        ...
        <div class="container-fluid">
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2 class="card-inside-title">Nova Pergunta</h2>
                        </div>
                                ...
                                <div id="dialogDespesas" title="Despesas">
                                    <table id="tbDespesa" class="table table-bordered table-striped table-hover">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <input type="text" class="form-control " id="pergunta" name="pergunta" style="border:0;" required />
                                                </td>
...
<script>
    (function () {
        ...
        AddTableRow = function () {
            ...
            cols += '<td><input type="text" class="form-control " id="pergunta" name="pergunta" style="border:0;"></td>';         
